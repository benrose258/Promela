...
short src_ln1 [] = {
	  0,  17,  18,  16,  15,  17,  18,  16, 
	 15,  61,  63,  17,  18,  16,  15,  64, 
	 64,  62,  66,  23,  22,  23,  22,  17, 
	 18,  16,  15,  71,  74,  23,  22,  17, 
	 18,  16,  15,  79,  81,  23,  22,  82, 
	 82,  80,  84,  23,  22,  86,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "zoo2.pml", 1, 45 },
...
short src_ln0 [] = {
	  0,  17,  18,  16,  15,  17,  18,  16, 
	 15,  29,  31,  17,  18,  16,  15,  32, 
	 32,  30,  34,  23,  22,  23,  22,  17, 
	 18,  16,  15,  39,  42,  45,  23,  22, 
	 17,  18,  16,  15,  50,  52,  23,  22, 
	 53,  53,  51,  55,  23,  22,  56,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "zoo2.pml", 1, 46 },
	{ "-", 47, 48 }
...
iniglobals(int calling_pid)
{
		...
		now.mutex = 1;
#ifdef VAR_RANGES
		logval("mice", now.mice);
		logval("felines", now.felines);
		logval("mutexMice", now.mutexMice);
		logval("mutexFelines", now.mutexFelines);
		logval("feedinglot", now.feedinglot);
...
{	/* int i; */
	printf("global vars:\n");
	printf("	byte   mice:	%d\n", now.mice);
	printf("	byte   felines:	%d\n", now.felines);
	printf("	byte   mutexMice:	%d\n", now.mutexMice);
	printf("	byte   mutexFelines:	%d\n", now.mutexFelines);
	printf("	byte   feedinglot:	%d\n", now.feedinglot);
	printf("	byte   mutex:	%d\n", now.mutex);
}
void
